...
describe('Template Content in HTML mode should', () => {
    it('Process: simple if expression', () => {
      const expected = '<div><h3>Your system is up to date.</h3></div>'
      cy.request({
        method: 'POST',
        url: '/',
        body: {
    ...
    it('Process: let expression', () => {
      const expected = '<p>You are running on eXist 6.2.0</p>'
      cy.request({
        method: 'POST',
        url: '/',
        body: {
          template: '[% let $version = system:get-version() %]\n  <p>You are running on eXist [[$version]]</p>\n[% endlet %]',
          params: {},
          mode: 'html'
        },
        failOnStatusCode: false
    ...
    it('include partials', () => {
      const expected = '<div><p>The footer below is loaded from <code>pages/footer.html</code></p><footer style="border-top: 1px solid #a0a0a0; margin-top: 1rem;"><p>Generated by TEI Publisher running on eXist v6.2.0.</p></footer><p>© e-editiones</p></div>'
      cy.request({
        method: 'POST',
        url: '/',
        body: {
